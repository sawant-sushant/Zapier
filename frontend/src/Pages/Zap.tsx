...
function useAvailableActionsAndTriggers() {
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/trigger/available`)
            .then(x => setAvailableTriggers(x.data.availableTriggers))

        axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/action/available`)
    ...
    return <div>
        ...
        <div className="flex justify-end p-4">
            <PrimaryButton onClick={async () => {
                ...
                await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/v1/zap`, {
        ...
        <div className="relative p-4 w-full max-w-2xl max-h-full">
            <div className="relative bg-white rounded-lg shadow ">
                ...
                <div className="p-4 md:p-5 space-y-4">
                    ...
                    {(step === 1 && selectedAction?.id === "send-rs") && <UPISelector    setMetadata={(metadata) => {
                        onSelect({
                            ...selectedAction,
                            metadata
                        })
